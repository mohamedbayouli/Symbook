...
return [
    ...
    'app_verify_payment' => [['token'], ['_controller' => 'App\\Controller\\PaymentController::verifyPayment'], [], [['variable', '/', '[^/]++', 'token', true], ['text', '/verify-payment']], [], [], []],
    ...
    'App\Controller\PaymentController::verifyPayment' => [['token'], ['_controller' => 'App\\Controller\\PaymentController::verifyPayment'], [], [['variable', '/', '[^/]++', 'token', true], ['text', '/verify-payment']], [], [], []],
