...
$context["commande"], "status", [], "any", false, false, false, 28) == "annulée")) {
                ...
                yield " dt</td>
                            <td>
                                <a href=\"";
                // line 35
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_commande_show", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["commande"], "id", [], "any", false, false, false, 35)]), "html", null, true);
                yield "\" 
...
{% endblock %}", "commande/index.html.twig", "C:\\xampp\\htdocs\\symfony 2025\\Symbook-main\\templates\\commande\\index.html.twig");
    }
}
