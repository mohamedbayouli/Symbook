 ...
 */
class getCommandeLivreRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CommandeLivreRepository' shared autowired service.
     *
     * @return \App\Repository\CommandeLivreRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CommandeLivreRepository.php';

        return $container->privates['App\\Repository\\CommandeLivreRepository'] = new \App\Repository\CommandeLivreRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
